                        ...
                        <tbody>
                            {filteredHouses.map((house) => (
                                <tr key={house.id} className="text-center">
                                    ...
                                    <td className="border border-black p-2 text-green-600 font-bold">{house.price}</td>
                                    <td className="border border-black p-2">{house.area}</td>
                                    <td className={`border border-black p-2 font-medium ${house.status === "available" ? "text-green-500" : "text-red-500"}`}>
